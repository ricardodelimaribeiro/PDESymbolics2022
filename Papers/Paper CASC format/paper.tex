...
In practice, to compute the Gr{\"o}bner basis, we assume non-zero parameters by default.
This assumption guarantees a Gr{\"o}bner basis only for one set of specializations $\Rr^2\backslash V(a,b)$. i.e., 
$\sigma(\Gg)$ is a Gr{\"o}bner basis of the specialization ideal $\sigma(\Ii)$ only for $\sigma \in \Rr^2\backslash V(a,b)$.
 The impact of this assumption is seen in (i) and (ii):
\begin{enumerate}
    ...
    \begin{example}
        ...
        Let $\Ii=\langle 
           ...
           the specialization $\sigma \in \Rr^2$ given by $P\rightarrow P(0,1)$.
           Now, We claim that the set $\sigma(\Gg)=\left\{y^3,-y^2,x y-2\right\}$ is not a Gr{\"o}bner basis.
    ...
    problem in \ref{sec2.1} can not be used for all specializations. 

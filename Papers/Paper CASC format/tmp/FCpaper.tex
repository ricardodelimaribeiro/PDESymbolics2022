...
\begin{algorithm}
	\DontPrintSemicolon
	\KwIn{\(\mathcal{J}\in\mathcal{F}(\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}^m),\mathcal{D}(\mathbb{N}))\) and \(\{H^1,\ldots,H^m\}\subset\mathcal{S}(\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}^m),\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}))\) right-hand side of a time-explicit scheme}
...
\begin{algorithm}
	\DontPrintSemicolon
	\KwIn{\(\mathcal{J}\in\mathcal{F}(\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}^m),\mathcal{D}(\mathbb{N}))\) and \(\{H^1,\ldots,H^i\}\subset\mathcal{S}(\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}^m),\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}))\) }
	\KwOut{ {\sc True}, if \(\mathcal{J}\) is conserved in time, {\sc False} otherwise }
...
\begin{algorithm}
	\DontPrintSemicolon
	\KwIn{right-hand side set of polynomials \(\{H^1,\ldots,H^m\}\subset S(\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}^m),\mathcal{P}(\mathcal{I}\times\mathbb{N},\mathbb{R}))\) ofa time-explicit scheme, list of {\sc generators}, {\sc degree} of polynomials }

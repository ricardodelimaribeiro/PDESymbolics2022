...
\author{Diogo A. Gomes\inst{1}\orcidID{0000-0002-3129-3956} \and
	Friedemann Krannich\inst{1}\orcidID{0000-0002-8642-4319} \and
...
\begin{abstract}
	...
	\keywords{Finite-difference schemes \and Discrete variational derivative \and Discrete partial variational derivative \and Conserved quantities \and Implicit schemes \and Explicit schemes \and Parametric Groebner systems.}
\end{abstract}
...
By shifting $n$, we see that	$\mathcal{J}$ and $\tilde{\mathcal{J}}$ represent the same quantity . Accordingly, $\mathcal{J}[0]=0=\tilde{\mathcal{J}}[0]$, and the discrete variational derivative must vanish
	...
	\end{gather*}
%	Hence, $\mathcal{V}(\mathcal{J}-\tilde{\mathcal{J}})=0$
%	and $\mathcal{J}[0]=0=\tilde{\mathcal{J}}[0]$. Thus, the functionals agree.
	%	both functionals represent the same quantity.
\end{example}
...
%	+D_2G(u(\tilde{n}+e^1),\ldots,u(\tilde{n}+e^k))\delta_{(t_1,\ldots,t_{l})}(s_1,\ldots,s_l)v(\tilde{n}+e^2)\\
+\ldots
...
\begin{theorem}[\cite{weispfenning}]

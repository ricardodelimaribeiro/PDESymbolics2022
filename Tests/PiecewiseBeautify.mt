...
variables = Association[
	...
	"indVars" -> {x},
	"pars" -> {a},
	"expression" -> Piecewise[{{1 + u[x]^2, a == 0}, {2*(1 + u[x]^2), a == 2}, {a + u[x]^2 + u[x]^a, -2*a + a^2 != 0}}, $Failed],
	"result" -> Piecewise[{{1 + u[x]^2, a == 0}, {2*(1 + u[x]^2), a == 2}, {a + u[x]^2 + u[x]^a, (-2 + a)*a != 0}}, $Failed]
];
Get[test]
...
variables = Association[
	...
	"indVars" -> {x},
	"pars" -> {a,b},
	"expression" -> Piecewise[{{2, a == 0 && b == 0}, {1 + a + u[x]^a, a != 0 && b == 0}, {2*(b + u[x]^b), a - b == 0 && b != 0}, {1 + b + u[x]^b, a == 0 && b != 0}, {a + b + u[x]^a + u[x]^b, a^2*b - a*b^2 != 0}}, $Failed],
	"result" -> 
	Piecewise[{{2, a == 0 && b == 0}, {1 + a + u[x]^a, a != 0 && b == 0}, {2*(b + u[x]^b), a == b && b != 0}, {1 + b + u[x]^b, a == 0 && b != 0}, {a + b + u[x]^a + u[x]^b, a*(a - b)*b != 0}}, $Failed]
];
Get[test]
...
variables = Association[
	...
	"indVars" -> {x,y},
	"pars" -> {a,b},
	"expression" -> Piecewise[{{{2, -2*u[x, y]*Derivative[1, 0][u][x, y] + Derivative[1, 0][v][x, y]}, a == 0 && b == 0}, {{2*u[x, y]^a, a*u[x, y]^(-1 + a)*v[x, y]*Derivative[1, 0][u][x, y] - 2*u[x, y]*v[x, y]^a*Derivative[1, 0][u][x, y] + u[x, y]^a*Derivative[1, 0][v][x, y] - a*u[x, y]^2*v[x, y]^(-1 + a)*Derivative[1, 0][v][x, y]}, (a - b == 0 && -2*b + b^2 != 0) || (a - b == 0 && -b + b^2 != 0) || (a - b == 0 && 2*b - 3*b^2 + b^3 != 0)}, {{u[x, y]*(1 + u[x, y]), 0}, a == 2 && b == 1}, {{1 + u[x, y]^a, -2*u[x, y]*Derivative[1, 0][u][x, y] + a*u[x, y]^(-1 + a)*v[x, y]*Derivative[1, 0][u][x, y] + u[x, y]^a*Derivative[1, 0][v][x, y]}, b == 0 && a != 0}, {{1 + u[x, y]^b, -2*u[x, y]*v[x, y]^b*Derivative[1, 0][u][x, y] + Derivative[1, 0][v][x, y] - b*u[x, y]^2*v[x, y]^(-1 + b)*Derivative[1, 0][v][x, y]}, a == 0 && b != 0}, {{u[x, y]^a + u[x, y]^b, a*u[x, y]^(-1 + a)*v[x, y]*Derivative[1, 0][u][x, y] - 2*u[x, y]*v[x, y]^b*Derivative[1, 0][u][x, y] + u[x, y]^a*Derivative[1, 0][v][x, y] - b*u[x, y]^2*v[x, y]^(-1 + b)*Derivative[1, 0][v][x, y]}, (a != 2 && -2*a^2*b + a^3*b + 2*a*b^2 - a^2*b^2 != 0) || (a != 2 && -(a^2*b) + a*b^2 + a^2*b^2 - a*b^3 != 0) || (-2*a^2*b + a^3*b + 2*a*b^2 - a^2*b^2 != 0 && b != 1) || (-(a^2*b) + a*b^2 + a^2*b^2 - a*b^3 != 0 && b != 1)}}, $Failed],
	"result" -> 
...
variables = Association[
	...
	"indVars" -> {x},
	"pars" -> {a,b},
	"expression" -> Piecewise[{{{2*u[x], u[x]*(7 + u[x]), 1}, a == 1}, {{1 + u[x], 8*u[x]^2, 1}, a == 0}, {{u[x] + u[x]^a, u[x]^(2 - a)*(7 + u[x]^a), 1}, -a + a^2 != 0}}, $Failed],
	"result" -> Piecewise[{{{2*u[x], u[x]*(7 + u[x]), 1}, a == 1}, {{1 + u[x], 8*u[x]^2, 1}, a == 0}, {{u[x] + u[x]^a, u[x]^(2 - a)*(7 + u[x]^a), 1}, (-1 + a)*a != 0}}, $Failed]
];
Get[test]
...
variables = Association[
	...
	"indVars" -> {x},
	"pars" -> {a,b},
	"expression" -> Piecewise[{{3*Derivative[1][u][x]^2, a == 2 && b == 4}, {2*Derivative[1][u][x]^2 + Derivative[1][u][x]^a, a - b == -2 && b != 4}, {Derivative[1][u][x]^2 + 2*Derivative[1][u][x]^a, 2*a - b == 0 && b != 4}, {2*Derivative[1][u][x]^2 + Derivative[1][u][x]^(-2 + b), a == 2 && b != 4}, {Derivative[1][u][x]^2 + Derivative[1][u][x]^a + Derivative[1][u][x]^(-a + b), (a != 2 && b == 4) || -8*a + 2*a^3 + 4*b + 4*a*b - 3*a^2*b - 2*b^2 + a*b^2 != 0}}, $Failed],
	"refine"-> True,
	"result" -> Piecewise[{{3*Derivative[1][u][x]^2, a == 2 && b == 4}, {2*Derivative[1][u][x]^2 + Derivative[1][u][x]^a, a == -2 + b && -4 + b != 0}, {Derivative[1][u][x]^2 + 2*Derivative[1][u][x]^a, a == b/2 && -4 + b != 0}, {2*Derivative[1][u][x]^2 + Derivative[1][u][x]^(-2 + b), a == 2 && -4 + b != 0}, {Derivative[1][u][x]^2 + Derivative[1][u][x]^a + Derivative[1][u][x]^(-a + b), (b == 4 && -2 + a != 0) || (-2 + a)*(2 + a - b)*(2*a - b) != 0}}, $Failed]
...
variables = Association[
	...
	"indVars" -> {x},
	"pars" -> {a},
	"expression" -> Piecewise[{{0, a == 1}, {-((-Derivative[1][u][x] + Derivative[1][u][x]^a)*Derivative[1][V][u[x]]), a != 1}}, $Failed],
	"refine"-> True,
	"result" -> Piecewise[{{0, a == 1}, {-((-Derivative[1][u][x] + Derivative[1][u][x]^a)*Derivative[1][V][u[x]]), -1 + a != 0}}, $Failed]
];
Get[test]

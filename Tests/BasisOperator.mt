...
test = FileNameJoin[{DirectoryName[$TestFileName], "BasisOperatorChild.mt"}];
Print["   BasisOperator"];
...
variables=Association[{
	...
	"result" -> Piecewise[{{{u[x], u[x]^a*v[x]^(4 - 3*a + b), Derivative[1][u][x]^2, u[x]^a*Derivative[1][u][x]^b}, b == 1}, {{u[x], u[x]^b, Derivative[1][u][x]^2, u[x]^a*Derivative[1][u][x]^b, Derivative[1][u][x]^(2*b)}, (b == -1 && a == 1) || (b == 2 && a == 2)}, {{u[x], u[x]^b, u[x]^a*v[x]^(4 - 3*a + b), Derivative[1][u][x]^2}, (b == 0 && a == 0) || (b == 0 && a == 1) || (b == 0 && a == 4/3)}, {{u[x], u[x]^b, u[x]^a*v[x]^(4 - 3*a + b), Derivative[1][u][x]^2, u[x]^a*Derivative[1][u][x]^b}, (-1 + a)*a*(-4 + 3*a) != 0 && b == 0}, {{u[x], u[x]^b, u[x]^a*v[x]^(4 - 3*a + b), Derivative[1][u][x]^2, Derivative[1][u][x]^(2*b)}, a == 0 && b == 2}, {{u[x], u[x]^b, u[x]^a*v[x]^(4 - 3*a + b), Derivative[1][u][x]^2, u[x]^a*Derivative[1][u][x]^b, Derivative[1][u][x]^(2*b)}, (-2 + a)*(-1 + a)*a*(-1 + b)*b != 0 || (-1 + a)*(-2 + b)*(-1 + b)*b != 0 || (-2 + a)*a*(-1 + b)*b*(1 + b) != 0 || (-2 + b)*(-1 + b)*b*(1 + b) != 0}}, $Failed]
}];
(*Get[ test ]*)(*only uncomment this when you really need to! Passed on 2021-04-05*)
...
variables = Association[{
	...
	"result" -> {Derivative[1][u][x]^2, u[x]*Derivative[2][u][x]}
}];
Get[ test ]
...
variables = Association[{
	...
	"result" -> {Derivative[1, 0][u][x, y]^2, 9*u[x, y]*Derivative[2, 0][u][x, y]}
}];
Get[ test ]
...
variables = Association[{
	...
	"MonList" -> {
  		...
  		u[x] u''[x],
  		u[x] u'''[x]},
  	"result" -> {u[x]^2, u[x]*Derivative[1][u][x], Derivative[1][u][x]^a, u[x]*Derivative[2][u][x], u[x]*Derivative[3][u][x]}
}];
Get[ test ]
...
variables = Association[{
	...
	"MonList" -> {E^ u[t] u'''[t], E^ u[t] u''[t] u'[t]},
  	"result" -> {E^u[t]*Derivative[1][u][t]*Derivative[2][u][t], E^u[t]*Derivative[3][u][t]}
}];
Get[ test ]
...
variables = Association[{
	...
	"MonList" -> {0, D[u[x, y], x],
  	...
  	"result" -> {v[x, y]*Derivative[0, 1][u][x, y] + u[x, y]*Derivative[0, 1][v][x, y], Derivative[1, 0][u][x, y]}
}];
Get[ test ]
...
variables = Association[{
	...
	"MonList" -> {m'[x], m[x]^2, m[x]^2 + 3 m'[x], 1 },
  	"result" -> {1, m[x]^2, Derivative[1][m][x]}
}];
Get[ test ]
...
variables = Association[{
	...
	"pars" -> {a},
	"VarDOperator" -> DVarDOperator,
	"MonList" -> {u[n], u[n]},(*did not run timelly with {u[n],u[n+a]}*)
	"result" -> {u[n]}
}];
Get[ test ]
...
variables = Association[{
	...
	"result" -> {u[x]^2, Derivative[1][u][x]*Derivative[1][V][u[x]]}
}];
Get[ test ]

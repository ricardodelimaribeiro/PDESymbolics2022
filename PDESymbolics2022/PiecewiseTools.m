...
PiecewiseAssociationClean[assoc_] :=
    PiecewiseMap[
      If[ Head[#] =!= Association,
          #,
          If[ Or @@ (KeyValueMap[Function[{key, value}, value === $Failed], #]),
              $Failed,
              #
          ]
      ]
...
PiecewiseReplace[xp_, rules_] :=
    PiecewiseBeautify@PiecewiseMap[If[ #[[1]]===$Failed||#[[2]]===$Failed,
                                       $Failed,
                                       #[[1]] /. #[[2]]
                                   ] &, PiecewiseExpand[{xp, rules//PiecewiseBeautify}]];
        ...
        If[ Head[xp] =!= Piecewise,
            ...
            Module[ {xpb, xpbl, xpblbc, xpblbcand, xpblbcandeq, facts, domain},
                ...
                If[ Head[xpb] =!= Piecewise,
                    ...
                    xpblbcand = Union @@ 
                           (Function[case, If[ Head[case[[2]]] === Or,
                                               List @@ ({case[[1]], #} & /@ case[[2]]),
                                               {case}
                                           ]] /@ xpblbc);
